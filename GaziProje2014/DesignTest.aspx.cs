...
namespace GaziProje2014
{
    public partial class DesignTest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //foreach (GridViewRow rw in RadGrid1.MasterTableView.Ite.Rows)
            //{
            //    foreach (GridDataItem item in RadGrid1.Items)//loops through each grid row
            //    {
            //        CheckBox chkBx = (CheckBox)item.FindControl("Check");
            //        if (chkBx != null && chkBx.Checked)
            //        {
            //            //string v= item["ColumnUniqueName"].Text;
            //            string v = item["KullaniciTipAdi"].Text; //accessing cell using its ColumnUniqueName
            //        }
            //    }
            //}
            //RadGrid1.Items
            ...
            //{
            //    message += item["KullaniciTipAdi"].Text + "\n";
            //}
