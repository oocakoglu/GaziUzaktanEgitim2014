    ...
    public class ChatHub : Hub
    {
        ...
        */
        ...
        public void RequestChat(string message)
        {
            ...
            if (lessBuzy == null)
            {
                Clients.Caller.addMessage("", "Hiçbir Operatör aktif deðil");
                return;
            }
            ...
            Clients.Client(lessBuzy.Id).addMessage(Context.ConnectionId, "Ziyaretci", message);
            Clients.Caller.addMessage("Ben", message);
        }
        ...
        public void Transfer(string connectionId, string agentName, string messages)
        {
            ...
            if(!agent.IsOnline)
            {
                Clients.Caller.addMessage(Context.ConnectionId, "system", agentName + " þu anda online.");
                return;
            }
        ...
        public void Send(string data)
        {
            ...
            if (ChatSessions.ContainsKey(Context.ConnectionId))
            {
                ...
                Clients.Client(opId).addMessage(Context.ConnectionId, "Ziyaretci", data);
            }
            else
            {
                Debug.WriteLine("Oturum Bulunamadý.");
