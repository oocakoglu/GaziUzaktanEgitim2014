<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCss.Master" AutoEventWireup="true" CodeBehind="SinavListesi.aspx.cs" Inherits="GaziProje2014.Forms.SinavListesi" %>
...
<%--                    <telerik:GridBoundColumn DataField="DersAdi"  HeaderText="Ders Adi" SortExpression="DersAdi" UniqueName="DersAdi">
    ...
    <div class="contentAlt30">
        <telerik:RadButton Width="100px" ID="btnSinavEkle" runat="server" Text="Sınav Ekle" OnClick="btnSinavEkle_Click"></telerik:RadButton>     
        <telerik:RadButton Width="100px" ID="btnSinavDuzenle" runat="server" Text="Sınav Düzenle" OnClick="btnSinavDuzenle_Click"></telerik:RadButton>     
        <telerik:RadButton Width="100px" ID="btnSinavSil" runat="server" Text="Sınav Sil" OnClick="btnSinavSil_Click"></telerik:RadButton>     

        <telerik:RadButton Width="100px" ID="btnSinavSonuclar" runat="server" Text="Sonuçları Göster"></telerik:RadButton> 
    </div>
