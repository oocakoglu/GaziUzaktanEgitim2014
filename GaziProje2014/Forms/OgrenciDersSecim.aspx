<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCss.Master" AutoEventWireup="true" CodeBehind="OgrenciDersSecim.aspx.cs" Inherits="GaziProje2014.Forms.OgrenciDersSecim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="OgretmenDersId">
                <Columns>
                    ...
                    <telerik:GridTemplateColumn UniqueName="chkTemplateColumn" Reorderable="False" Groupable="False">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkOgrenciOnay"  runat="server" AutoPostBack="False"></asp:CheckBox>
                        </ItemTemplate>
    ...
    <div class="contentAlt30">
        <telerik:RadButton Width="150px" ID="btnOgrenciDersSec" runat="server" Text="Dersleri Seç" OnClick="btnOgrenciDersSec_Click"></telerik:RadButton>     
    </div>
